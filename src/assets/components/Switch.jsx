  ...
  return (
    <>
       <h2 className="text-[#999999] lg:text-2xl">new</h2>
            ...
            />
            <h2 className="text-[#999999] lg:text-2xl">old</h2>
    </>
  )
}
