  ...
  export default function Footer() {
    ...
    <footer className=' flex flex-col items-center justify-around xl:gap-80 h-72 lg:flex-row lg:w-[60%] lg:justify-between  border-b-4 border-neutral-400'>
      ...
      <div className=" lg:float-right">
        ...
        <button className=" font-poppins flex rounded items-center gap-2 text-right bg-orange-500 text-white px-10 lg:px-14 py-3 font-bold hover:bg-orange-600" ><Anchor to='/donation'>Donate <img src={corazon} alt="" /></Anchor></button>
