...
function handleChangeSwitch()
{
  ...
  return (
    <>
        ...
        <div className="flex flex-col  h-fit sm:min-h-[70vh] items-center ">
         {contador > 4 ? 
          ...
          {mangas.map((each ) => (
            ...
            <div key={each?.title} className="flex flex-col  w-[45%] h-[40vh]  pb-2 sm:w-[30%] 2xl:w-[20%] 2xl:h-[50vh]  shadow-2xl 2xl:bg-white" >
             <Anchor to="/manga/:id" className="h-[82%] ">
      ...
      ): <div className="text-3xl font-bold text-orange-600 text-center lg:mt-40 mt-24 "> This author has no published article yet <br/> maybe you want to continue exploring other authors
      </div>}
    </>
  );
}
