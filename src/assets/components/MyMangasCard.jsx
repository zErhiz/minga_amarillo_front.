...
//funcion para eliminar el manga 
  ...
  return (
    <div  key={manga._id}className='  w-72 sm:w-80 h-32 flex rounded-2xl mt-7   shadow-2xl  sm:m-5 items-center  bg-slate-50' >
            ...
            <div className="h-[20%] flex items-center ml-3">
                <img /* onClick={} */ className="h-3  sm:h-4  object-cover" src={further} alt="" />
                <img  /* onClick={} */ className="h-3 sm:h-4      ml-2  object-cover" src={pencil}alt="" />
            </div>
